...
node_id = "Master_2"  # Change node ID as needed
topic_temperature = "temperature2"  # Change topic as needed
...
def visualize_dag(nx_graph):
    ...
    labels = {node: node for node in nx_graph.nodes()}  # Show full labels
