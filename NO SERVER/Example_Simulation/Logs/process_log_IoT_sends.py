...
df['Master_Node'] = pd.Categorical(df['Master_Node'], categories=['Master_1', 'Master_2', 'Master_3', 'Master_4'])
...
ax1.set_yticks([0, 1, 2, 3])  # Indices for the master nodes
ax1.set_yticklabels(['Master_1', 'Master_2', 'Master_3', 'Master_4'], fontsize=30)
ax1.grid(True)
